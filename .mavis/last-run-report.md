...
- Issue #4760 "test : add unit tests for useAntiGravityScroll hook" -> PR #4765 [test] -- status: GREEN (build/lint/typecheck pass) -- files: frontend/src/hooks/**tests**/useAntiGravityScroll.test.tsx
- Issue #4761 "test : add unit tests for route_param utility" -> PR #4766 [test] -- status: CLOSED -- files: backend/src/shared/**tests**/route_param.test.ts -- closed: blocked by pre-existing backend TS errors
- Issue #4762 "test : add unit tests for sanitization helpers" -> PR #4767 [test] -- status: CLOSED -- files: backend/src/app/utils/**tests**/sanitization.test.ts -- closed: blocked by pre-existing backend TS errors
...
- Issue #4764 "test : add unit tests for useDebounced hook" -> PR #4771 [test+fix] -- status: PENDING CI (lint pass; build/typecheck fail due to pre-existing backend errors) -- files: frontend/package.json + frontend/src/hooks/**tests**/useDebounced.test.ts
