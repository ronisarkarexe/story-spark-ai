  ...
  if (paragraphs.length >= 3) {
    ...
    if (avgLength > 80 && stdDev < 15) {
      suggestions.push({
        ...
        description: "Monotonous Paragraph Length. Most of your paragraphs are similarly long. Try breaking up some paragraphs or introducing shorter, punchier sentences to create a more dynamic pacing."
      });
    }
