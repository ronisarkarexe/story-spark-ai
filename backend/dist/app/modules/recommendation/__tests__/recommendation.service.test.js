...
jest.mock("../../post/post.model", () => {
    ...
    return Object.assign(Object.assign({}, actual), { Post: {
            find: jest.fn(),
        } });
});
...
const readPostId = new mongoose_1.Types.ObjectId("507f1f77bcf86cd799439012");
const token = {
    _id: userId.toString(),
    email: "reader@example.com",
    role: "user",
};
const createUserQuery = (result) => {
    const query = {
...
const createRecommendationPost = (id, overrides = {}) => (Object.assign({ _id: id, title: "A focused story", imageURL: "https://example.com/story.jpg", author: {
        _id: userId,
        name: "Reader Writer",
        profile: {
            avatar: "https://example.com/avatar.jpg",
        },
    }, emotions: ["Joy"], genre: "Fantasy", likesCount: 10, viewsCount: 100, publishedAt: new Date("2026-01-01T00:00:00.000Z"), createdAt: new Date("2026-01-01T00:00:00.000Z") }, overrides));
describe("RecommendationService.getPersonalizedRecommendations", () => {
    beforeEach(() => {
        jest.clearAllMocks();
    });
    it("uses lean projected reads for user and preferred post recommendations", () => __awaiter(void 0, void 0, void 0, function* () {
        const post = createRecommendationPost(new mongoose_1.Types.ObjectId("507f1f77bcf86cd799439013"));
        const user = {
            readingPreferences: {
                favoriteGenres: [
        ...
        const result = yield recommendation_service_1.RecommendationService.getPersonalizedRecommendations(token);
        ...
        expect(preferredPostQuery.populate).toHaveBeenCalledWith("author", AUTHOR_RECOMMENDATION_FIELDS);
        expect(preferredPostQuery.select).toHaveBeenCalledWith(POST_RECOMMENDATION_FIELDS);
    ...
    it("preserves fallback recommendation behavior and excludes already returned posts", () => __awaiter(void 0, void 0, void 0, function* () {
        const preferredPostId = new mongoose_1.Types.ObjectId("507f1f77bcf86cd799439014");
        const fallbackPostId = new mongoose_1.Types.ObjectId("507f1f77bcf86cd799439015");
        ...
        expect(fallbackPostQuery.select).toHaveBeenCalledWith(POST_RECOMMENDATION_FIELDS);
        expect(fallbackPostQuery.lean).toHaveBeenCalledTimes(1);
    }));
    it("uses fallback popular posts when no preferences are available", () => __awaiter(void 0, void 0, void 0, function* () {
        const fallbackPost = createRecommendationPost(new mongoose_1.Types.ObjectId("507f1f77bcf86cd799439016"));
        createUserQuery({
            readingHistory: [readPostId],
        });
        const fallbackPostQuery = createPostQuery([fallbackPost]);
    ...
    it("does not mutate reading preference arrays while ranking preferences", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield recommendation_service_1.RecommendationService.getPersonalizedRecommendations(token);
...
describe("recommendation query indexes", () => {
    it("registers indexes for published popularity and preference recommendation queries", () => {
        const indexKeys = post_model_1.PostSchema.indexes().map(([keys]) => keys);
