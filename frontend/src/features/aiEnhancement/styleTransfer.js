class StyleTransferEngine {
  constructor() {
    this.styles = {
      formal: {
        vocabulary: { said: "articulated", happy: "delighted" },
        pace: "slow",
      },
      casual: { vocabulary: { said: "said", hello: "hey" }, pace: "normal" },
      poetic: {
        vocabulary: { said: "whispered", dark: "shadowed" },
        pace: "varied",
      },
      technical: {
        vocabulary: { thing: "element", process: "algorithm" },
        pace: "precise",
      },
      humorous: {
        vocabulary: { sad: "tragically bummed", said: "quipped" },
        pace: "snappy",
      },
    };
  }
