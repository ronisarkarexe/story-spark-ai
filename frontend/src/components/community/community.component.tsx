      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-12 leading-relaxed dark:text-gray-400">
            Join thousands of writers using AI to spark their creativity. Share
            your stories, get feedback, and find your next great narrative
            adventure.
          </p>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-slate-600 dark:text-gray-400">
              Find your niche and connect with specialists in your favorite
              storytelling styles. Each hub offers specific AI prompt templates
              and discussion boards.
            </p>
          </div>
          <Link
            to="/community"
            className="group flex items-center text-blue-400 font-semibold transition-all"
          >
            <span className="underline underline-offset-8 decoration-blue-500/30 group-hover:decoration-blue-500 transition-all uppercase">
              View All Genres
            </span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
          {stats.map((stat, idx) => (
            <div key={idx} className="text-center group">
              <div className="text-5xl font-bold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors dark:text-white dark:group-hover:text-blue-400">
                {stat.value}
              </div>
      ...
      >
        <div className="p-16 rounded-[2.5rem] bg-gradient-to-br from-blue-50 via-white to-slate-100 border border-gray-200 shadow-2xl relative overflow-hidden text-slate-900 transition-colors duration-300 dark:from-blue-900/40 dark:via-slate-900 dark:to-black dark:border-white/10 dark:text-white">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900 dark:text-white">
            Ready to spark your first story?
          </h2>
          <p className="text-slate-600 dark:text-gray-400 text-lg mb-12 max-w-xl mx-auto leading-relaxed">
            Experience the power of generative AI and join the most innovative
            writing community on the web.
          </p>
