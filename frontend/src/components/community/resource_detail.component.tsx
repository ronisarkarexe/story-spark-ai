    ...
    return (
      <div className="min-h-screen bg-white text-slate-900 pt-32 pb-20 flex flex-col items-center justify-center transition-colors duration-300 dark:bg-[#0b1329] dark:text-white">
        ...
        <p className="text-slate-600 mb-8 dark:text-gray-400">
          The writing resource you are looking for does not exist.
        </p>
        <Link to="/resources">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12">
          ...
          <div className="p-6 md:p-8 rounded-2xl bg-gray-50 border border-gray-200 text-slate-900 dark:bg-slate-900/40 dark:border-white/5 dark:text-white">
            <h2 className="text-lg font-bold mb-3 text-blue-600 dark:text-blue-400">
              Beginner-Friendly Guidance
            </h2>
          ...
          <div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {resource.tips.map((tip, index) => (
                <li
                  key={index}
                  className="flex items-start gap-3 text-slate-600 bg-gray-50 p-4 rounded-xl border border-gray-200 dark:text-gray-300 dark:bg-white/5 dark:border-white/5"
                >
          ...
          <div>
            <h2 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">
              Concise Templates & Examples
            </h2>
            <div className="space-y-6">
              {resource.examples.map((ex, index) => (
                <div
                  key={index}
                  className="bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6 text-slate-900 dark:bg-slate-950/60 dark:border-white/5 dark:text-white"
                >
                  <div className="font-semibold text-blue-600 mb-3 text-sm md:text-base dark:text-blue-400">
                    {ex.label}
                  </div>
