...
<div className="absolute bottom-16 left-1/3 w-4 h-4 bg-violet-300 rounded-full blur-[3px] animate-pulse"></div>
    ...
    ${index === 0
                      ? "bg-[radial-gradient(circle_at_top_left,rgba(250,204,21,0.18),transparent_45%)]"
                      : index === 1
                        ? "bg-[radial-gradient(circle_at_top_left,rgba(96,165,250,0.18),transparent_45%)]"
                        : index === 2
                          ? "bg-[radial-gradient(circle_at_top_left,rgba(251,146,60,0.18),transparent_45%)]"
