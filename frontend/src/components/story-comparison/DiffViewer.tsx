...
const DiffViewer: React.FC<DiffViewerProps> = ({
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      similarity:
        total > 0
          ? (((total - (added + removed)) / total) * 100).toFixed(1)
          : 100,
    };
  }, [differences]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-slate-100 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
        <p className="text-xs font-bold text-slate-600 dark:text-slate-400 mb-3 uppercase">
          Legend
        </p>
      ...
      <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-700 p-6">
        <h4 className="text-sm font-bold text-slate-600 dark:text-slate-400 mb-4 uppercase">
          Title Comparison
        </h4>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-slate-300 dark:border-slate-600">
          <div className="text-xs text-slate-600 dark:text-slate-400">
            <p className="font-bold mb-1">
              Version {version1.versionNumber} Info
            </p>
          ...
          <div className="text-xs text-slate-600 dark:text-slate-400">
            <p className="font-bold mb-1">
              Version {version2.versionNumber} Info
            </p>
