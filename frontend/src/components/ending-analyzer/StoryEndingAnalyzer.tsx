...
export default function StoryEndingAnalyzer({ story, onRegenerate }: Props) {
  const analysis = useMemo(() => analyzeStoryEnding(story), [story]);
  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6">
      ...
      <div className="mb-6">
        <h3 className="font-semibold text-white mb-3">Weak Points</h3>
      ...
      <button
        onClick={() => onRegenerate?.(regenerateEndingPrompt(story))}
