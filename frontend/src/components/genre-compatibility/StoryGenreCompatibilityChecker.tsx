...
import { analyzeGenreCompatibility } from "../../utils/storyGenreCompatibilityChecker";
    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6">
      ...
      <div className="space-y-5">
        {analysis.issues.map((issue) => (
          <div key={issue.id} className="rounded-lg border border-zinc-700 p-5">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold text-white">{issue.section}</h3>
            ...
            <p className="mt-2 text-indigo-400">{issue.category}</p>

            <p className="mt-3 text-gray-300">{issue.explanation}</p>
