        ...
        <div className="flex flex-wrap gap-2">
          {badges.length > 0 ? (
            badges.map((badge, idx) => (
              <span
                key={idx}
                className="px-3 py-1 bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 text-xs font-bold rounded-full border border-yellow-200 dark:border-yellow-500/30 flex items-center gap-1"
              >
            ...
            <span className="text-xs text-slate-400 italic">
              No badges yet. Write your first story!
            </span>
          )}
        </div>
      </div>
