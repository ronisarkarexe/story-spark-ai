  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-white text-slate-900 transition-colors duration-300 dark:bg-[#070c18] dark:text-white">
      ...
      <header className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex items-center justify-between dark:bg-[#0a1020] dark:border-white/[0.06]">
        ...
        <div className="flex items-center gap-4 text-slate-900 dark:text-white">
          ...
          <ImageFallback
            ...
            src={data?.profile?.avatar || user?.avatar || "https://avatars.githubusercontent.com/u/76697055?v=4"}
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className={`bg-gray-50 border-r border-gray-200 transition-all duration-300 dark:bg-[#0a1020] dark:border-white/[0.06] flex flex-col justify-between ${isSidebarCollapsed ? "w-20" : "w-64"}`}>
          ...
          <div className="p-4 border-t border-slate-200 dark:border-white/[0.06]">
            <button
              ...
              className="w-full px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-white/[0.05] dark:hover:bg-white/[0.1] transition text-sm flex items-center justify-center font-medium"
            >
              <i
                className={`fas ${
                  isSidebarCollapsed
