    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          ...
          <div
            key={card.label}
            className="bg-slate-50 border border-slate-200 dark:bg-white/[0.02] dark:border-white/[0.06] rounded-2xl p-4 text-center shadow-lg"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Productive Hours */}
        <div className="bg-slate-50 border border-slate-200 dark:bg-white/[0.02] dark:border-white/[0.06] rounded-2xl p-6 shadow-lg">
          <h2 className="text-lg font-semibold mb-1 text-slate-800 dark:text-white">
            ⏰ Most Productive Hours
          </h2>
          {maxHour && maxHour.count > 0 && (
