    ...
    >
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className={`text-2xl font-bold mt-1 ${isActive ? "text-white" : "text-gray-200"}`}>{count}</p>
        </div>
        <i
        ...
        <div className="relative px-6 py-8 lg:px-8 lg:py-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm lg:text-base max-w-2xl">
              Create, manage, and organize your blog posts. Monitor engagement metrics, publish content, and track post
        ...
        <table className="min-w-full divide-y divide-gray-800/60">
          <thead className="bg-[#141624]/80 backdrop-blur-sm">
            <tr>
              ...
              <th scope="col" className="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Author</th>
              <th scope="col" className="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Topics</th>
