    ...
    <div className="w-full min-w-0 max-w-full box-border">
      ...
      <div className="relative w-full max-w-full flex items-center box-border">
        ...
        <input
          ...
          className={`w-full min-w-0 max-w-full h-11 block box-border rounded-xl border bg-white dark:bg-slate-900/40 text-sm transition-all duration-200 focus:outline-none focus:ring-2 ${icon ? "pl-11" : "px-4"
            } ${isPasswordType ? "pr-11" : "pr-4"} ${error
      ...
      {error && (
        <p
          className="text-xs font-semibold text-rose-500 mt-1.5 text-left w-full break-words"
          aria-live="polite"
        >
          {error.message}
        </p>
