    ...
    <div className="w-full max-w-full flex flex-col box-border">
      ...
      <div className="relative w-full max-w-full flex items-center box-border">
        ...
        <input
          type={inputType}
          id={name}
          className={`block w-full max-w-full box-border pl-8 pr-10 py-1.5 text-base text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 bg-white dark:bg-slate-800 border rounded-md sm:text-sm ${
            error
              ? "border-red-500 outline-red-500"
              : "border-gray-300 dark:border-slate-700 focus:outline-indigo-600"
          }`}
