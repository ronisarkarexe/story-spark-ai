    ...
    <div className="w-full min-w-0 max-w-full box-border">
      ...
      <div className="relative mt-2 flex items-center w-full min-w-0 max-w-full box-border">
        ...
        <input
          ...
          className={`ss-input block h-11 w-full min-w-0 max-w-full overflow-hidden text-ellipsis whitespace-nowrap box-border rounded-xl border text-sm transition-all duration-200 ${
            icon ? "pl-10" : "px-4"
