...
const SSButton: FC<SSButtonProps> = ({
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      aria-busy={isLoading}
      className={`motion-cta flex w-full justify-center items-center gap-2 max-w-full min-w-0 box-border h-12 rounded-xl bg-indigo-600 px-4 text-sm font-semibold text-white shadow-md shadow-indigo-500/20 transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 ${
        isDisabled
