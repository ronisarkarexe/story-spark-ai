...
const CookieConsentBanner: FC<CookieConsentBannerProps> = ({ onLayoutChange }) => {
  ...
  const bannerClasses = isDark
    ? "fixed inset-x-0 bottom-0 z-50 bg-slate-950/95 border-t border-slate-200/10 dark:border-white/10 py-6 shadow-2xl backdrop-blur-xl text-white transition-colors duration-300 max-h-[85vh] overflow-y-auto"
    : "fixed inset-x-0 bottom-0 z-50 bg-white/95 border-t border-slate-200 py-6 shadow-2xl backdrop-blur-xl text-slate-900 transition-colors duration-300 max-h-[85vh] overflow-y-auto";
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 sm:px-6 lg:px-8 xl:flex-row xl:items-start xl:justify-between xl:gap-8">
        ...
        <div className="max-w-3xl space-y-4">
          <div className="space-y-1.5">
            ...
            <h2 className={`text-xl sm:text-2xl font-bold tracking-tight ${primaryText}`}>
          ...
          <div className={panelClasses}>
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              {/* Analytics Cookies - User choice, full width */}
              <div className={`${cardClasses} sm:col-span-2 flex-col sm:flex-row sm:items-center sm:justify-between gap-4`}>
                <div className="space-y-1 max-w-xl">
                  ...
                  <p className={`text-xs leading-normal ${mutedText}`}>
                    Help us understand interface engagement data to continuously refine the StorySpark AI 
                    ecosystem module suite paths.
                  </p>
                </div>
