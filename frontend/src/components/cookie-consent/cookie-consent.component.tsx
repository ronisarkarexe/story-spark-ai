...
const CookieConsentBanner: FC<CookieConsentBannerProps> = ({ onLayoutChange }) => {
  ...
  <div
    ref={bannerRef}
    className="fixed inset-x-0 bottom-0 z-50 bg-slate-950/95 border-t border-slate-200/10 py-6 shadow-2xl backdrop-blur-xl text-white"
  >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              >
                <div className="space-y-1 max-w-xl">
                  ...
                  <p className={`text-xs leading-normal ${mutedText}`}>
                    Help us understand interface engagement data to improve the
                    StorySpark AI experience.
                  </p>
                </div>
