...
const ReportBug = () => {
  const [submitBugReport, { isLoading: isSubmitting }] =
        ...
        {isSuccess ? (
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg mb-10">
              Thank you for helping us make StorySparkAI better. Our team will
              review your report and take action as soon as possible.
            </p>
            <button
            ...
            <div className="text-center mb-16">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-slate-900 dark:text-white mb-6">
                  Report a{" "}
                  <span className="text-blue-600 dark:text-blue-400">Bug</span>
                </h1>
                <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto font-medium">
                  Help us improve StorySparkAI by reporting issues in a
                  structured way. Detailed reports help us fix things faster.
                </p>
              ...
              >
                    ...
                    <div className="relative group/input">
                      ...
                      <textarea
                        ...
                        {...register("steps", {
                          ...
                          maxLength: {
                            value: 2000,
                            message: "Steps must be under 2000 characters",
                          },
                        })}
                        maxLength={2000}
                        aria-required="true"
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-slate-800">
                  ...
                  <p className="mt-3 text-xs text-slate-500 dark:text-slate-400 ml-1">
                    Provide your email if you'd like us to reach out for more
                    details or updates on the fix.
                  </p>
                </div>
        ...
        <div className="w-full max-w-4xl relative z-10 mt-12 mb-12 flex flex-col items-center">
          <div className="p-6 bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/20 rounded-2xl flex items-start gap-4 max-w-2xl">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
              By submitting this report, you agree that the details provided can
              be used by StorySparkAI's development team to improve the
              platform.
            </p>
          </div>
        </div>
