...
const StoryInspirationComponent: React.FC = () => {
  ...
  const savedGenreClean = savedPrefs.defaultGenre
    .replace(/^\p{Emoji}\s*/u, "")
    .trim();
  const initialGenre = genres.includes(savedGenreClean)
    ? savedGenreClean
    : "All";
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#f5f7ff] dark:bg-[#050816] text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-28">
        ...
        >
          <button
            onClick={() => navigate("/")}
            className="group inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/70 dark:bg-white/[0.05] border border-white/60 dark:border-white/10 backdrop-blur-xl shadow-sm hover:border-indigo-400/40 transition-all duration-300 text-slate-700 dark:text-slate-300 text-sm font-semibold"
          >
  ...
  dark:to-purple-300"
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-xl leading-relaxed text-slate-600 dark:text-slate-400">
            ...
            <span className="block mt-3 text-base text-indigo-600 dark:text-indigo-300 font-semibold">
              ✨ Browse inspirations below, then click "Generate Custom Story"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-20 max-w-4xl mx-auto">
            {[
              ...
              <motion.div
                key={index}
                whileHover={{ y: -6 }}
                className="relative overflow-hidden rounded-[2rem] border border-white/60 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] backdrop-blur-2xl p-7 shadow-xl shadow-black/[0.04]"
              >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 mb-10">
              <div>
                ...
                <p className="mt-3 text-slate-600 dark:text-slate-400 max-w-2xl">
                  Search through genres, themes, and iconic storytelling
                  structures to unlock your next idea.
                </p>
              </div>
  ...
  "
              ...
              {searchQuery.length > 0 && (
                <button
                  ...
                  className="w-11 h-11 rounded-2xl bg-red-50 dark:bg-red-500/10 hover:scale-105 transition-all duration-300 text-red-500"
                >
            ...
            <p className="mt-3 text-xs text-slate-500 dark:text-slate-400 text-center">
              💡 Tip: Try searching by theme, genre, or author to find your
              perfect inspiration
            </p>
        ...
        <div className="w-full min-h-[50vh] transition-all duration-300">
          {filteredStories.length > 0 ? (
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="max-w-2xl mx-auto rounded-[2.5rem] border border-white/60 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] backdrop-blur-2xl p-16 text-center shadow-2xl"
            >
              ...
              <p className="mt-4 text-slate-600 dark:text-slate-400 leading-relaxed max-w-md mx-auto">
                Try adjusting your search keywords or explore different genres
                to uncover more creative ideas.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
        ...
        >
          <div className="rounded-[2rem] border border-indigo-200/60 dark:border-indigo-500/20 bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl p-8 md:p-10 shadow-lg">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-6">
              Follow these simple steps to turn inspiration into your next great
              story.
            </p>
              ...
              {[
                {
                  step: "01",
                  title: "Browse & Filter",
                  desc: "Explore story cards by genre or search by theme, author, or keyword.",
                  icon: "fa-magnifying-glass",
                },
                {
                  step: "02",
                  title: "Find Your Spark",
                  desc: "Click on any story card to read the summary, themes, and writing prompts.",
                  icon: "fa-lightbulb",
                },
                {
                  step: "03",
                  title: "Generate Your Story",
                  desc: 'Use the inspiration as a base and click "Generate Custom Story" to create your own.',
          ...
          <div className="relative overflow-hidden rounded-[3rem] border border-white/60 dark:border-white/10 bg-gradient-to-br from-indigo-600 via-blue-600 to-purple-700 p-10 md:p-16 text-white shadow-[0_25px_100px_rgba(79,70,229,0.35)]">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="mt-6 text-lg text-white/80 leading-relaxed">
                Use StorySparkAI to transform inspirations into complete
                stories, plots, and cinematic adventures powered by intelligent
                AI storytelling.
              </p>
