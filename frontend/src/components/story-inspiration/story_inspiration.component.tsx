  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f5f7ff] dark:bg-[#050816] text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.04] dark:opacity-[0.06] bg-[linear-linear(to_right,#6366f1_1px,transparent_1px),linear-linear(to_bottom,#6366f1_1px,transparent_1px)] bg-[size:60px_60px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-28">
        ...
        <motion.section initial={{ opacity: 0, y: 35 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative pt-20 pb-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl xl:text-8xl font-black tracking-tight leading-[0.95] mb-8">
            ...
            <span className="block text-transparent bg-clip-text bg-linear-to-r from-indigo-600 via-blue-600 to-purple-600 dark:from-indigo-300 dark:via-blue-300 dark:to-purple-300">
              Inspiration Hub
            </span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-12">
            <button
              ...
              className="group px-8 py-4 rounded-2xl bg-linear-to-r from-indigo-600 to-blue-600 text-white font-bold shadow-2xl shadow-indigo-500/25 hover:scale-[1.03] transition-all duration-300"
            >
        ...
        <motion.section id="discover-section" initial={{ opacity: 0, y: 35 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="mb-20">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/60 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] backdrop-blur-2xl shadow-[0_25px_80px_rgba(0,0,0,0.06)] p-6 md:p-10">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 mb-10">
              ...
              <div className="px-5 py-4 rounded-2xl bg-linear-to-r from-indigo-500/10 to-blue-500/10 border border-indigo-500/10 min-w-[220px]">
        ...
        {filteredStories.length > 0 ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-2xl mx-auto rounded-[2.5rem] border border-white/60 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] backdrop-blur-2xl p-16 text-center shadow-2xl">
            ...
            <button
              ...
              className="mt-10 px-8 py-4 rounded-2xl bg-linear-to-r from-indigo-600 to-blue-600 text-white font-bold hover:scale-[1.03] transition-all duration-300 shadow-xl shadow-indigo-500/20"
            >
              Reset Filters
            </button>
          </motion.div>
        ...
        <motion.section initial={{ opacity: 0, y: 35 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="mt-8">
          <div className="relative overflow-hidden rounded-[3rem] border border-white/60 dark:border-white/10 bg-linear-to-br from-indigo-600 via-blue-600 to-purple-700 p-10 md:p-16 text-white shadow-[0_25px_100px_rgba(79,70,229,0.35)]">
