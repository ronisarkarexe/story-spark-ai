...
export default function StoryWorldMap({ story, title, onClose }: Props) {
  ...
  useEffect(() => {
      ...
      nodes = [
        {
          ...
          name: "Forest",
          type: "location",
          excerpt: "A dark forest...",
        },
        {
          id: "loc_2",
          name: "Castle",
          type: "location",
          excerpt: "An ancient castle...",
        },
        {
          id: "loc_3",
          name: "Village",
          type: "location",
          excerpt: "A quiet village...",
        },
        {
          id: "char_1",
          name: "Hero",
    ...
    node
      ...
      .attr("fill", (n: SimNode) =>
        n.type === "location" ? "rgba(99,102,241,0.2)" : "rgba(236,72,153,0.2)",
      )
      .attr("stroke", (n: SimNode) =>
        n.type === "location" ? "#6366f1" : "#ec4899",
      )
      .attr("stroke-width", 2);
    ...
    node
      ...
      .attr("font-size", (n: SimNode) =>
        n.type === "location" ? "18px" : "14px",
      )
    ...
    simulation.on("tick", () => {
      ...
      node.attr(
        "transform",
        (n: SimNode) => `translate(${n.x ?? 0},${n.y ?? 0})`,
      );
    });
      ...
      <div className="w-full max-w-5xl bg-[#0d0d14] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
        ...
        <div className="border-t border-white/10 px-6 py-3">
          <p className="text-xs text-white/30">
            Drag to rearrange. Scroll to zoom. Click to explore.
          </p>
        </div>
      </div>
    </div>
