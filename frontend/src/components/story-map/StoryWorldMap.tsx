  ...
  useEffect(() => {
    ...
    node
      ...
      .attr("stroke", (node: SimNode) =>
        node.type === "location" ? "#6366f1" : "#ec4899",
      )
      .attr("stroke-width", 2);
    ...
    node
      ...
      .attr("font-size", (node: SimNode) =>
        node.type === "location" ? "18px" : "14px",
      )
    ...
    node
      ...
      .attr("fill", (node: SimNode) =>
        node.type === "location" ? "#a5b4fc" : "#f9a8d4",
      )
      .attr("font-size", "11px")
    ...
    simulation.on("tick", () => {
      ...
      node.attr(
        "transform",
        (node: SimNode) => `translate(${node.x ?? 0},${node.y ?? 0})`,
      );
    });
