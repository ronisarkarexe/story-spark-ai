...
const emotionKeywords = {
  ...
  Sad: ["sad", "cry", "tears", "pain", "lonely", "loss", "broken"],

  Suspense: ["mystery", "dark", "fear", "danger", "secret", "shadow"],

  Excitement: ["adventure", "fight", "victory", "energy", "thrill", "power"],
};
...
export const STORY_TEMPLATES = [
    ...
    characters: [
      {
        ...
        name: "Elara",
        role: "Protagonist",
        personality: "Courageous but naive, struggling with their new power.",
      },
      {
        id: "char-2",
        name: "Kaelen",
        role: "Mentor",
        personality: "Cynical, battle-hardened, harbors a secret guilt.",
      },
      {
        id: "char-3",
        name: "Lyra",
        role: "Companion",
        personality: "Inquisitive, brilliant, hiding her true motives.",
      },
    ],
    length: "long",
  },
    ...
    characters: [
      {
        ...
        role: "Protagonist",
        personality: "Determined, weary, seeking redemption.",
      },
      {
        id: "char-2",
        name: "Sarah",
        role: "Witness",
        personality: "Fearful, secretive, holds the key to the mystery.",
      },
      {
        id: "char-3",
        ...
        role: "Antagonist",
        personality:
          "Authoritative, corrupt, desperate to protect the status quo.",
      },
    ],
    length: "medium",
  },
  {
    ...
    premise:
      "Two high school sweethearts, who were torn apart by ambition and misunderstandings, unexpectedly cross paths a decade later in their hometown. One has returned to take over their family's failing business, while the other is a successful developer looking to buy the property. As they are forced to work together to find a compromise, old sparks reignite. However, they must confront the unresolved issues that caused their initial breakup and decide if they are willing to risk their hearts again, or if they have simply grown too far apart to make it work.",
    plotPoints: [
    ...
    characters: [
      {
        ...
        role: "Protagonist",
        personality:
          "Ambitious, guarded, struggles to balance career and personal life.",
      },
      {
        id: "char-2",
        name: "Julian",
        role: "Love Interest",
        personality: "Charming, successful, regrets past mistakes.",
      },
      {
        id: "char-3",
        name: "Elena",
        role: "Best Friend",
        personality: "Supportive, meddling, wants them to get back together.",
      },
    ],
    length: "medium",
  },
    ...
    characters: [
      {
        ...
        name: "Dr. Aris Thorne",
        role: "Protagonist",
        personality: "Brilliant, isolated, deeply committed to the truth.",
      },
      {
        id: "char-2",
        name: "General Vance",
        role: "Ally",
        personality: "Pragmatic, skeptical, but ultimately loyal to humanity.",
      },
      {
        id: "char-3",
        name: "Agent Silas",
        role: "Antagonist",
        personality: "Ruthless, manipulative, represents the rogue faction.",
      },
    ],
    length: "long",
  },
    ...
    characters: [
      {
        ...
        role: "Protagonist",
        personality:
          "Resourceful, determined, thrust into extraordinary circumstances.",
      },
      {
        id: "char-2",
        name: "The Fixer",
        role: "Antagonist",
        personality: "Cold, calculating, an expert tracker.",
      },
      {
        id: "char-3",
        name: "Sam",
        role: "Ally",
        personality: "Paranoid, tech-savvy, lives off the grid.",
      },
    ],
    length: "medium",
  },
  {
    ...
    premise:
      "A family looking for a fresh start moves into a beautiful, historic home they bought at a surprisingly low price. Soon, strange occurrences begin: objects move on their own, unexplained noises echo through the halls at night, and the children start talking to unseen 'friends.' As the paranormal activity escalates and becomes violent, the parents investigate the house's dark history. They discover that the property was built on cursed land and that the spirits trapped there demand a terrifying sacrifice. They must find a way to break the curse before they become the house's next victims.",
    plotPoints: [
    ...
    characters: [
      {
        ...
        name: "The Parent",
        role: "Protagonist",
        personality: "Protective, skeptical at first, then desperate.",
      },
      {
        id: "char-2",
        name: "The Child",
        role: "Victim",
        personality: "Innocent, sensitive to the paranormal.",
      },
      {
        id: "char-3",
        name: "The Historian",
        role: "Expert",
        personality: "Knowledgeable, eccentric, warns of the danger.",
      },
    ],
    length: "short",
  },
