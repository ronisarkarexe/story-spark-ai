...
const StoryAchievementDashboard: React.FC<Props> = ({ totalStories }) => {
  ...
  return (
    <div className="bg-slate-800 rounded-2xl p-5 shadow-lg text-white mt-6">
      {/* Header */}
      <h2 className="text-xl font-bold mb-4">🏆 Writing Achievements</h2>
      ...
      {/* Achievement Badges */}
      <div className="mb-5">
        <h3 className="font-semibold mb-2">Unlocked Badges</h3>
      ...
      {nextAchievement && (
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            {totalStories} / {nextAchievement.target} stories completed
          </p>
        </div>
      )}
