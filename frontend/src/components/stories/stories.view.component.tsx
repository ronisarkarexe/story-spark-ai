...
const StoryCoverImageInline: React.FC<StoryCoverImageProps> = ({
    ...
    return (
      <div
        ...
        style={{
          ...
          letterSpacing: "0.05em", textShadow: "0 1px 4px rgba(0,0,0,0.4)",
  ...
  return (
    <div
      className={className}
      style={{
        width: "100%", height: "100%", minHeight: "192px",
    ...
    >
      ...
      <div style={{ position: "absolute", top: "14px", left: "14px", background: "rgba(0,0,0,0.4)", backdropFilter: "blur(6px)", color: "#fff", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "3px 10px", borderRadius: "999px", border: `1px solid ${theme.accent}55`, userSelect: "none" }}>
        {tag}
      </div>
      {!imageUrl && (
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(to top, rgba(0,0,0,0.85) 0%, transparent 100%)", padding: "40px 14px 14px" }}>
        <p style={{ margin: 0, color: "#fff", fontSize: "0.95rem", fontWeight: 700, lineHeight: 1.3, textShadow: "0 2px 8px rgba(0,0,0,0.8)", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
          {title}
        </p>
      </div>
    </div>
