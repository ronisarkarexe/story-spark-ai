              ...
              <div className="contact-form-card">
                ...
                >
                  ...
                  <button
                    ...
                    disabled={loading}
                    aria-busy={loading}
                    aria-label={loading ? "Sending messageGǪ" : "Send message"}
                  ...
                  {success && (
                    ...
                    >
                      ...
                      <p className="text-sm font-medium text-emerald-400">
                        Message sent G�� we'll get back to you within 24 hours.
                      </p>
                    </div>
                  )}
