...
export default function StoryReadingInfo({ story }: Props) {
  const info = useMemo(() => analyzeReadingInfo(story), [story]);
    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5 mb-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="rounded-lg bg-zinc-800 p-4">
          ...
          <h3 className="text-3xl font-bold text-white">{info.wordCount}</h3>
        </div>

        <div className="rounded-lg bg-zinc-800 p-4">
          <p className="text-gray-400">Estimated Reading Time</p>
