...
import { analyzeStorySymbolism } from "../../utils/storySymbolismDetector";
...
export default function StorySymbolismDetector({ story, onRefresh }: Props) {
  const symbols = useMemo(() => analyzeStorySymbolism(story), [story]);
      ...
      <div className="space-y-5">
        {symbols.map((item) => (
          <div key={item.id} className="rounded-lg border border-zinc-700 p-5">
            ...
            <p className="mt-3 text-gray-300">{item.meaning}</p>
