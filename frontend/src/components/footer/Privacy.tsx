      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-[#1e293b] rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="bg-[#334155] p-5 rounded-xl">
                <h3 className="font-semibold mb-2 text-lg">Platform Improvement</h3>
                <p className="text-gray-300">We use data to improve AI story generation, user experience, and platform performance.</p>
              </div>
              <div className="bg-[#334155] p-5 rounded-xl">
                <h3 className="font-semibold mb-2 text-lg">Personalization</h3>
                <p className="text-gray-300">Your preferences help us generate more relevant stories and recommendations.</p>
              </div>
              <div className="bg-[#334155] p-5 rounded-xl">
                <h3 className="font-semibold mb-2 text-lg">Security</h3>
                <p className="text-gray-300">We monitor suspicious activity and protect accounts from unauthorized access.</p>
              </div>
              <div className="bg-[#334155] p-5 rounded-xl">
                <h3 className="font-semibold mb-2 text-lg">Communication</h3>
                <p className="text-gray-300">We may send important updates, policy changes, and service announcements.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 shadow-lg text-center">
            ...
            <p className="text-lg text-white/90 mb-3">If you have any questions regarding this Privacy Policy, feel free to contact us.</p>
