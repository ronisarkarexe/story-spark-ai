        ...
        <div className="grid grid-cols-12 gap-x-6 gap-y-10 items-start">
          ...
          <div className="col-span-12 sm:col-span-8 lg:col-span-2 flex flex-col gap-4">
            ...
            <form
              ...
              noValidate
              className="group/form mt-1 flex flex-col gap-3 rounded-xl border border-white/[0.08] bg-[#0D1630]/60 p-4 backdrop-blur-sm transition-all duration-300 focus-within:border-blue-500/30"
            >
              <div className="flex items-center gap-2 h-11 rounded-xl bg-[#0B1228]/60 px-3 border border-white/[0.06]">
              ...
              <button
                type="submit"
                disabled={status === "loading"}
                className="self-start h-11 px-4 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-[13px] font-semibold text-white hover:from-blue-400 hover:to-indigo-400 active:scale-95 transition-all duration-200 disabled:opacity-60"
              >
