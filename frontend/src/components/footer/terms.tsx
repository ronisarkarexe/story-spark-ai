...
const Terms = () => {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] px-4 sm:px-6 py-24 pt-28 sm:pt-32 flex items-start transition-colors duration-300">
      <div className="max-w-4xl mx-auto w-full text-center lg:text-left">
        ...
        {/* Description */}
        <p className="text-[var(--text-secondary)] text-base sm:text-lg leading-7 sm:leading-8 max-w-2xl mx-auto mb-8">
          Please read these terms carefully before using StorySparkAI to ensure a safe and inspiring community.
        </p>

        {/* Content Section */}
        <div className="bg-[var(--card-bg)] border border-[var(--border-color)] shadow-2xl rounded-3xl p-6 sm:p-8 sm:px-10 backdrop-blur-sm transition-all duration-300 hover:border-blue-500/40 text-left">
