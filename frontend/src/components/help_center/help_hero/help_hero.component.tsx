  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 lg:pt-12 lg:pb-16 box-border w-full">
        ...
        {/* Main Content */}
        <div className="text-center max-w-4xl mx-auto w-full box-border">
          <motion.div
          ...
          >
            ...
            <span className="ml-2 text-sm flex items-center justify-center">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-400 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed font-medium">
            Find answers, troubleshoot workspace issues, and check local developer guides across the StorySparkAI node pipeline ecosystem.
          </p>
