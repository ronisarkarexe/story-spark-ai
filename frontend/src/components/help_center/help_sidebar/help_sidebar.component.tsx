                ...
                {HELP_SECTIONS.map((section) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative group w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 overflow-hidden border focus:outline-none text-left box-border ${
                        isActive
                          ? "border-blue-300 dark:border-blue-500/30 bg-gradient-to-r from-blue-500/10 to-indigo-500/10"
                          : "border-slate-200 dark:border-white/5 hover:border-blue-200 dark:hover:border-white/10 bg-white/50 dark:bg-white/[0.03]"
                      }`}
                    >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-2.5 text-xs transition-all duration-300 shadow-md"
                  >
                    Open Support Hub
                  </button>
                </div>
              ...
              <button
                ...
                className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                  isSelected
                    ...
                    : "bg-white dark:bg-white/5 text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-white/10"
                }`}
              >
                {section.label}
              </button>
