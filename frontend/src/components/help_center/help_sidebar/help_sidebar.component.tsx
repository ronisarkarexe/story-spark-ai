...
const sectionIcons: Record<string, string> = {
  ...
  "troubleshoot-section": "fa-wrench",
  "faq-section": "fa-circle-question",
  "developer-setup": "fa-gears",
  "support-links-section": "fa-comments",
};
                ...
                {HELP_SECTIONS.map((section) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <i className={`fa-solid ${sectionIcons[section.id] || "fa-circle-info"} text-sm relative z-10`} aria-hidden="true" />
