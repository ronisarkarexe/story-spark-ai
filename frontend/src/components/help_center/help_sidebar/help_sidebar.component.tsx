...
const HELP_SECTIONS = [
  { id: "help-categories", label: "Categories", icon: "fa-layer-group" },
  ...
  { id: "setup-guide-section", label: "Setup Guide", icon: "fa-rocket" },
                ...
                return (
                  ...
                  >
                    <div className="min-w-0 flex-1 flex items-center gap-4">
                      ...
                      <p className={`font-bold text-xs sm:text-sm tracking-tight transition-colors duration-200 ${
                        isActive
