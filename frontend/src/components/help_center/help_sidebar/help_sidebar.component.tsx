...
const HELP_SECTIONS = [
  ...
  { id: "developer-setup", label: "Setup Guide", icon: "fa-rocket", color: "from-emerald-500 to-teal-500" },
                ...
                {HELP_SECTIONS.map((section) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <i className={`relative z-10 fa-solid ${section.icon} text-sm ${isActive ? "text-blue-600 dark:text-blue-400" : "text-slate-500"}`} aria-hidden="true" />
                      ...
                      <div className="relative z-10">
                        <div className={`w-2 h-2 rounded-full transition-all duration-300 ${isActive ? "bg-blue-500 scale-125 shadow-[0_0_12px_rgba(59,130,246,0.7)]" : "bg-slate-300 dark:bg-slate-700"}`} />
                      </div>
                    </button>
                  );
                })}
