                ...
                {HELP_SECTIONS.map((section) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10 flex items-center justify-center w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:scale-110 transition-transform duration-300">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-2.5 text-sm transition-all duration-300 shadow-md shadow-blue-500/10 cursor-pointer"
                  >
                    Open Support Hub
                  </button>
                </div>
