...
const sectionIcons: Record<string, string> = {
  "help-categories": "fa-layer-group",
  "faq-section": "fa-circle-question",
  "troubleshoot-section": "fa-screwdriver-wrench",
  "developer-setup": "fa-rocket",
  "setup-guide-section": "fa-rocket",
  "support-links-section": "fa-headset",
};
const HelpSidebar = () => {
        ...
        <div className="sticky top-24">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-200 dark:border-blue-500/20 mb-3">
                ...
                {HELP_SECTIONS.map((section) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative group w-full flex items-center gap-3 px-3.5 py-3 rounded-2xl transition-all duration-300 overflow-hidden border focus:outline-none ${
                        isActive
                    ...
                    >
                      ...
                      <i className={`fa-solid ${sectionIcons[section.id] || "fa-circle-info"} text-sm relative z-10 ${isActive ? "text-blue-500" : "text-slate-500"}`} aria-hidden="true" />
                      <div className="relative z-10 flex-1 text-left">
                        <p className={`font-semibold text-xs sm:text-sm transition-colors duration-300 ${isActive ? "text-slate-900 dark:text-white" : "text-slate-700 dark:text-slate-300"}`}>
                          {section.label}
                        </p>
                      </div>
                      <div className="relative z-10">
                        <div className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${isActive ? "bg-blue-500 scale-125 shadow-[0_0_12px_rgba(59,130,246,0.7)]" : "bg-slate-300 dark:bg-slate-700"}`} />
                      </div>
                    </button>
                  );
                })}
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-600 dark:text-slate-400">Contact support</p>
                    </div>
                  </div>
                  <button
                    onClick={() => scrollToSection("support-links-section")}
                    className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-xs font-semibold py-2.5 transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-blue-500/20"
                  >
                    Support Links
                  </button>
                </div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-thin">
          {HELP_SECTIONS.map((section) => (
            <button
              ...
              type="button"
              onClick={() => scrollToSection(section.id)}
              className={`flex-shrink-0 px-4 py-2 rounded-full text-xs font-medium transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
