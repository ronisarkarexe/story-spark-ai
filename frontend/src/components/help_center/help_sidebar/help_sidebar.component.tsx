...
const HELP_SECTIONS = [
  ...
  { id: "setup-guide-section", label: "Setup Guide", icon: "fa-terminal", color: "from-emerald-500 to-teal-500" },
  { id: "faq-section", label: "FAQ", icon: "fa-circle-question", color: "from-indigo-500 to-violet-500" },
  { id: "troubleshoot-section", label: "Troubleshooting", icon: "fa-screwdriver-wrench", color: "from-orange-500 to-amber-500" },
  { id: "support-links-section", label: "Support Links", icon: "fa-headset", color: "from-pink-500 to-rose-500" },
];
