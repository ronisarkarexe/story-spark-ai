...
const HelpSidebar = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:block w-full max-w-full box-border" aria-label="Help center desktop navigation">
        <motion.div
        ...
        >
          ...
          <div className="absolute inset-0 rounded-3xl border border-white/30 dark:border-white/5 pointer-events-none" />
