              ...
              {HELP_SECTIONS.map((section) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 min-w-0 flex-1 flex items-center gap-4">
                      <i className={`fa-solid ${section.icon} text-sm ${isActive ? "text-blue-500" : "text-slate-400"}`} aria-hidden="true" />
                    ...
                    <div className="relative z-10 shrink-0">
                      <div className={`w-1.5 h-1.5 rounded-full transition-all duration-200 ${isActive ? "bg-blue-500 scale-125 shadow-[0_0_12px_rgba(59,130,246,0.7)]" : "bg-slate-300 dark:bg-slate-700"}`} />
                    </div>
                  </button>
                );
              })}
