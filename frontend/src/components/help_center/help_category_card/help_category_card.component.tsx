...
const HelpCategoryCard: FC<HelpCategoryCardProps> = ({ category }) => {
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex items-center gap-1.5 mt-5 text-xs sm:text-sm text-blue-600 dark:text-blue-400 group-hover:text-blue-500 dark:group-hover:text-blue-300 font-bold tracking-tight select-none">
        Browse Section
        <i
