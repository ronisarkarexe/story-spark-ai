          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="relative z-10 w-full box-border">
                {/* Icon Layout */}
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-500/20 flex items-center justify-center text-xl sm:text-2xl text-blue-500 dark:text-blue-400 mb-5 sm:mb-6 select-none group-hover:scale-105 transition-transform duration-300">
              ...
              <div className="relative z-10 mt-6 flex items-center justify-between select-none">
                ...
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg sm:rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 flex items-center justify-center text-slate-400 text-xs sm:text-sm group-hover:text-white group-hover:bg-blue-500 group-hover:border-blue-500/20 transition-all duration-200">
