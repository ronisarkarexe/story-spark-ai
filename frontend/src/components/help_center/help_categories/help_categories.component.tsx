  ...
  return (
    ...
    >
      ...
      {!categories || categories.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-slate-300 dark:border-white/10 bg-slate-100 dark:bg-white/[0.03] p-8 sm:p-12 text-center max-w-4xl mx-auto box-border">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-slate-200 dark:bg-slate-800 flex items-center justify-center mx-auto mb-5 border border-slate-200/60 dark:border-white/5">
            <i className="fa-solid fa-magnifying-glass text-2xl sm:text-3xl text-slate-500 dark:text-slate-400"></i>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6 px-4 sm:px-0 w-full box-border">
          {categories.map((category, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111827]/40 backdrop-blur-2xl hover:border-blue-500/40 dark:hover:border-blue-500/30 transition-all duration-300 shadow-sm hover:shadow-xl p-6 sm:p-7 w-full box-border flex flex-col justify-between"
            >
              {/* Glow effects */}
              ...
              <div className="relative z-10 w-full box-border">
                {/* Icon Layout */}
                <div
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-500/20 flex items-center justify-center text-xl sm:text-2xl text-blue-500 dark:text-blue-400 mb-5 sm:mb-6 select-none group-hover:scale-105 transition-transform duration-300"
                >
              ...
              <div className="relative z-10 mt-6 flex items-center justify-between select-none">
                ...
                <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 flex items-center justify-center text-slate-400 text-xs sm:text-sm group-hover:text-white group-hover:bg-blue-500 group-hover:border-blue-500/20 transition-all duration-300"
                >
