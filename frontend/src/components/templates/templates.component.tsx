  ...
  return (
    <div className="group relative bg-white dark:bg-white/[0.02] backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-indigo-500/20 hover:border-indigo-500/50 dark:hover:border-indigo-500/50 transition-all duration-500 flex flex-col h-full transform hover:-translate-y-1">
      ...
      <div className="p-6 flex flex-col flex-grow relative z-20 -mt-10">
        {/* Icon overlay */}
        <div
          className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-lg backdrop-blur-md border border-white/50 dark:border-white/20 mb-4 ${color} relative z-30 ring-4 ring-white dark:ring-[#0B0F19]`}
        >
  ...
  const storyTemplates = [
    {
      ...
      title: "Fantasy Story",
      description:
        "Craft epic tales of magic, legendary heroes, and mythical realms.",
      prompt:
        "Write a fantasy story about a magical kingdom, hidden secrets, and an unexpected hero.",
      icon: "fas fa-dragon",
    ...
    },
    {
      ...
      title: "Mystery Story",
      description:
        "Build suspenseful narratives with twists, clues, and revelations.",
      prompt:
        "Write a suspenseful mystery involving a strange disappearance and an unexpected twist.",
    ...
    },
    {
      ...
      title: "Romance Story",
      description:
        "Create emotional journeys of connection, love, and relationships.",
      prompt:
        "Write a heartwarming romance story about two people meeting under unusual circumstances.",
      icon: "fas fa-heart",
      color: "bg-pink-500",
      image:
    ...
    },
    {
      ...
      title: "Horror Story",
      description:
        "Thrill your readers with chilling atmospheres and haunting entities.",
      prompt:
        "Write a chilling horror story involving a haunted place and an unknown presence.",
      icon: "fas fa-ghost",
      color: "bg-red-500",
      image:
    ...
    },
    {
      ...
      title: "Sci-Fi Story",
      description:
        "Explore futuristic technologies, space travel, and cosmic mysteries.",
      prompt:
        "Write a science fiction story about humanity's first encounter with an advanced alien civilization.",
      icon: "fas fa-rocket",
      color: "bg-blue-500",
      image:
    ...
    },
    {
      ...
      description:
        "Embark on thrilling quests full of danger, discovery, and action.",
      prompt:
        "Write an action-packed adventure story about explorers searching for a lost ancient artifact.",
      icon: "fas fa-compass",
      color: "bg-amber-500",
      image:
  ...
  const creativeTemplates = [
    {
      ...
      description:
        "Flesh out deep, compelling histories and motivations for your characters.",
      prompt:
        "Create a detailed backstory for a mysterious character with hidden motivations.",
    ...
    },
    {
      ...
      description:
        "Generate natural and engaging conversations between characters.",
      prompt:
        "Write an intense and revealing dialogue between two old friends who share a dark secret.",
    ...
    },
    {
      ...
      description:
        "Spark new ideas with dynamic and unexpected story outlines.",
      prompt:
        "Outline a compelling plot for a novel where the protagonist wakes up with a special ability.",
    ...
    },
    {
      ...
      title: "Poem Writing",
      description:
        "Express emotions and vivid imagery through rhythmic poetry.",
      prompt:
        "Write a beautiful and emotional poem about the passage of time and fleeting memories.",
    ...
    },
    {
      ...
      description:
        "Get the perfect opening paragraph to kickstart your short fiction.",
      prompt:
        "Write a gripping opening paragraph for a short story set in a dystopian future.",
  ...
  const inspirationTemplates = [
    {
      ...
      prompt:
        "Give me 5 unique and thought-provoking story prompts involving time travel.",
    ...
    },
    {
      ...
      description:
        "Push past creative hurdles with targeted writing exercises.",
      prompt:
        "I am experiencing writer's block. Provide a fun, unconventional 5-minute writing exercise to get me started.",
      icon: "fas fa-hammer",
      color: "bg-rose-500",
      image:
    ...
    },
    {
      ...
      title: "Scene Builder",
      description:
        "Construct vivid, atmospheric environments for your narratives.",
      prompt:
        "Describe in vivid, sensory detail a bustling marketplace in a cyberpunk city.",
      icon: "fas fa-city",
      color: "bg-violet-500",
      image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <div className="text-center mb-24 relative mt-4">
          ...
          <p className="text-xl text-slate-600 dark:text-gray-400 max-w-xl mx-auto mb-10 leading-relaxed font-light">
            Skip the blank page. Choose from beautifully crafted templates for
            stories, poems, characters, and creative inspiration.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a
              href="#categories"
              className="px-8 py-4 rounded-xl border font-bold text-lg transition-all duration-300 backdrop-blur-sm w-full sm:w-auto text-center  bg-white text-slate-700 border-slate-300  hover:bg-slate-100 hover:border-indigo-500 hover:text-indigo-600 hover:-translate-y-1 hover:shadow-lg  dark:bg-white/5 dark:text-gray-200 dark:border-white/10 dark:hover:bg-indigo-500/10 dark:hover:text-indigo-300"
            >
              Browse Templates
            </a>
          </div>
          ...
          <div className="relative bg-gradient-to-b from-white to-slate-50 dark:from-[#0f1423]/90 dark:to-[#0B0F19]/90 backdrop-blur-xl rounded-3xl p-12 md:p-20 border border-slate-200 dark:border-white/5 text-center overflow-hidden h-full w-full shadow-xl dark:shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="text-xl text-slate-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto font-light leading-relaxed">
                Choose a template, spark an idea, and let Story Spark AI turn
                your imagination into something unforgettable.
              </p>
              <button
                onClick={() => navigate("/stories")}
