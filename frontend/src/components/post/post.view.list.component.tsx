      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {posts.length > 0 ? (
          posts.map((story) => (
            ...
            >
              <div className="relative overflow-hidden bg-slate-200 dark:bg-slate-800 aspect-[16/10]">
                <ImageFallback
                  src={story.imageURL}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-50 via-transparent to-transparent opacity-100 pointer-events-none dark:from-slate-900/90 dark:via-transparent dark:to-transparent" />
