...
import NotificationComponent from "../notification/NotificationComponent.component";

// Mock assets/states to satisfy compiler if context isn't fully imported globally
...
const NavListComponent: React.FC<NavProps> = ({
  isLogin = false,
  isAdmin = false,
  unreadCount = 0,
  notifications = [],
  ...
  const getLinkClass = (isActive: boolean) =>
    `inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-semibold transition-all duration-300 ${
      isActive
