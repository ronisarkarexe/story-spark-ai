  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="relative min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 overflow-hidden transition-colors duration-300 w-full box-border">
      ...
      <div className="relative overflow-hidden w-full box-border" onMouseMove={handleMouseMove}>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 sm:pt-20 sm:pb-20 w-full box-border">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <motion.h1
                ...
                className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-tight text-center lg:text-left select-none"
              ...
              <motion.p
                variants={itemVariants}
                className="max-w-2xl lg:mx-0 mx-auto text-lg sm:text-xl text-slate-600 dark:text-slate-400 leading-relaxed mb-10 transition-colors duration-300 font-medium"
              >
              ...
              <motion.div variants={itemVariants} className="w-full flex flex-col items-center lg:items-start justify-center lg:justify-start">
                <div className="relative max-w-3xl w-full box-border">
                  <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 select-none">
                    <button
                      onClick={() => {
                      ...
                      className={`w-full sm:w-auto px-6 sm:px-8 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm font-bold shadow-md shadow-blue-500/10 transition-all duration-150 flex items-center justify-center gap-2.5 uppercase tracking-wider ${
                        isNavigating
                    ...
                    <Link to="/collab" className="w-full sm:w-auto">
                      <button className="w-full sm:w-auto px-6 sm:px-8 py-3.5 rounded-xl bg-white/80 dark:bg-[#111827]/40 backdrop-blur-md border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white text-xs sm:text-sm font-bold shadow-sm hover:bg-slate-50 dark:hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-[0.98] transition-all duration-150 flex items-center justify-center gap-2.5 cursor-pointer uppercase tracking-wider">
                        <span>✍️</span>
