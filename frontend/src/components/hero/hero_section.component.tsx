...
const HeroParticles = () => {
  ...
  useGSAP(() => {
    ...
    particles.forEach((particle, i) => {
      ...
      gsap.to(particle, {
        x: config.xMove, y: config.yMove, scale: 1.4, opacity: 0.9,
        duration: config.dur / 2, ease: "sine.inOut", yoyo: true, repeat: -1, delay: i * 0.3,
      });
    });
  }, { scope: containerRef });
...
const HeroSectionComponent = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(badge, { boxShadow: "0 0 16px rgba(59,130,246,0.2), 0 0 40px rgba(139,92,246,0.1)", duration: 1.2, ease: "sine.inOut", yoyo: true, repeat: -1 });
  });
      ...
      <div className="relative overflow-hidden w-full box-border" onMouseMove={handleMouseMove}>
        ...
        <motion.div variants={itemVariants} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 sm:pt-20 sm:pb-20 text-center w-full box-border">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <motion.h1 variants={itemVariants} className="text-3xl sm:text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 sm:mb-8 leading-tight select-none text-left">
              ...
              <p className="max-w-2xl text-sm sm:text-lg lg:text-xl text-slate-600 dark:text-slate-400 leading-relaxed mb-8 sm:mb-10 font-medium text-left">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <button
                  ...
                  className={`px-6 sm:px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm font-bold shadow-md shadow-blue-500/10 transition-all duration-150 flex items-center gap-2.5 uppercase tracking-wider ${
                    isNavigating ? "opacity-75 cursor-not-allowed" : "hover:from-blue-500 hover:to-indigo-500 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                  }`}
                >
                  {isNavigating ? (
                    <>
                    ...
                    <><i className="fa fa-wand-magic-sparkles text-sm" /><span>Get Started</span></>
                  )}
                </button>
                <Link to="/collab">
