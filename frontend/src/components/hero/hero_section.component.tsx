  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="relative min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 overflow-hidden transition-colors duration-300 w-full box-border">
      ...
      <div className="relative overflow-hidden w-full box-border" onMouseMove={handleMouseMove}>
        <motion.div variants={itemVariants} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20 text-center w-full box-border">
          <div
            ref={badgeRef}
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-tight select-none" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 select-none">
            <Link to="/stories">
              <button className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold shadow-lg shadow-blue-500/25 hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 flex items-center gap-2.5 cursor-pointer">
                <i className="fa fa-wand-magic-sparkles"></i>
                <span>Get Started</span>
              </button>
            </Link>
            <Link to="/collab">
              <button className="px-8 py-3.5 rounded-xl bg-white/80 dark:bg-[#111827]/40 backdrop-blur-md border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white font-semibold shadow-sm hover:bg-slate-50 dark:hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-[0.98] transition-all duration-150 flex items-center gap-2.5 cursor-pointer">
                <span>✍️</span>
