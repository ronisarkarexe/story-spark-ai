            ...
            <div className="relative max-w-3xl w-full box-border">
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 select-none">
                <button
                  ...
                  className={`w-full sm:w-auto px-6 sm:px-8 py-3 rounded-xl bg-gradient-to-r from-fuchsia-600 to-orange-500 text-white text-xs sm:text-sm font-bold shadow-md shadow-fuchsia-500/10 transition-all duration-150 flex items-center justify-center gap-2.5 uppercase tracking-wider ${
                    isNavigating
                      ? "opacity-75 cursor-not-allowed"
                      : "hover:from-fuchsia-500 hover:to-orange-400 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                  }`}
                >
                  {isNavigating ? (
                    <>
