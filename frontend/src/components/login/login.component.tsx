  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 flex items-center justify-center relative overflow-hidden p-4 sm:p-8 box-border">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 box-border">
        ...
        >
          <div className="flex items-center gap-6 border border-gray-200 dark:border-slate-700/50 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800/40 dark:text-gray-400">
          ...
          <div className="flex items-center gap-6 border border-gray-200 dark:border-slate-700/50 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800/40 dark:text-gray-400">
            ...
            <div>
              <h2 className="font-bold text-slate-900 dark:text-white">Endless Creativity</h2>
          ...
          <div className="flex items-center gap-6 border border-gray-200 dark:border-slate-700/50 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800/40 dark:text-gray-400">
            ...
            <div>
              <h2 className="font-bold text-slate-900 dark:text-white">Built for everyone</h2>
        ...
        <div className="flex justify-center w-full box-border">
          <div className="w-full max-w-md bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-8 sm:p-10 shadow-2xl box-border overflow-hidden relative">
            ...
            <button
              ...
              className="mb-4 text-sm text-blue-500 dark:text-blue-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200 flex items-center gap-2 cursor-pointer bg-transparent border-none p-0"
            >
              ← Back to Home
            </button>
            ...
            <form className="space-y-5 w-full min-w-0 box-border" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex justify-end -mt-2">
                <Link
                  to="/forgot-password"
                  className="text-xs font-semibold text-blue-500 dark:text-blue-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200"
                >
                  Forgot Password?
                </Link>
              </div>
            ...
            <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
              ...
              <Link
                to="/signup"
                className="font-semibold text-blue-500 dark:text-blue-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200"
              >
                Sign up for free
              </Link>
            </p>
