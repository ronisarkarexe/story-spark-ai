    ...
    <div className="min-h-screen bg-white dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 flex items-center justify-center relative overflow-hidden px-4 box-border">
      ...
      <div className="w-full max-w-7xl mx-auto py-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 w-full">
          ...
          <div className="relative w-full max-w-md bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-8 sm:p-10 shadow-2xl">
