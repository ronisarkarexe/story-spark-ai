...
const steps = [
  {
    num: "01",
    label: "Paste or type your story",
    detail: "Start from zero or drop in mid-draft.",
  },
  {
    num: "02",
    label: "Choose what you need",
    detail: "Continue, polish, unblock, or get feedback.",
  },
  {
    num: "03",
    label: "Iterate and own it",
    detail: "Refine suggestions until the words feel like yours.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(124,93,250,0.12) 0%, transparent 70%)",
            }}
          />
          <div
            style={{
        ...
        >
          StorySpark's AI Writing Assistant meets you mid-sentence. Whether
          you're wrestling with plot, voice, or the blank page itself — your
          creative co-pilot is ready.
        </p>
      ...
      <section
        style={{ padding: "5rem 2.5rem", maxWidth: 1100, margin: "0 auto" }}
      >
        <p
          style={{
            fontSize: "0.72rem",
        ...
        >
          {features.map((f) => (
            ...
            >
              ...
              />
              <div style={{ color: f.accent, marginBottom: "1rem" }}>
                {f.icon}
              </div>
              <div
                style={{
            ...
            <div key={stat.label}>
              <p
                style={{
                  ...
                  color: "#E8E6F0",
                  marginBottom: "0.3rem",
                  background: "linear-gradient(90deg,#7C5DFA,#4F8EF7)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                }}
      ...
      >
        <div style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(ellipse, rgba(124,93,250,0.1) 0%, transparent 70%)",
            }}
          />
        </div>
        <p
        ...
        >
          Join thousands of writers already using StorySpark to push past limits
      ...
      >
        <span>
          © 2026 StorySpark<span style={{ color: "#7C5DFA" }}>AI</span> ·
