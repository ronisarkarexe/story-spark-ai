...
const MOCK_SPOTLIGHT_POSTS = [
  ...
  },
  {
    ...
    content: "Behind the old house, wildflowers had taken over what used to be a carefully tended garden — and somehow, it was more beautiful.",
  ...
  },
  {
    ...
    content: "Every box held a memory — faded photographs, handwritten letters, and the faint scent of a summer long gone.",
