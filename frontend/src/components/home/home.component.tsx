...
const HomeComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100 w-full box-border overflow-x-hidden">
      ...
      >
        {/* Main Feed Content */}
        <motion.main className="col-span-12 lg:col-span-8 min-w-0 w-full box-border space-y-8 sm:space-y-12">
        ...
        {/* Sidebar */}
        <motion.aside className="col-span-12 lg:col-span-4 min-w-0 w-full box-border">
        ...
        <div className="col-span-12 space-y-12 w-full mt-10">
