  ...
  if (isError) {
    return (
      <section className="mb-12">
        ...
        <div className="rounded-xl border border-red-200 dark:border-red-900/40 bg-red-50 dark:bg-red-950/30 p-6 text-center">
          <p className="mb-4 text-sm font-semibold text-red-700 dark:text-red-400">Failed to load latest posts. Please try again.</p>
          <button
            onClick={() => refetch()}
            className="motion-cta inline-flex items-center gap-2 rounded-lg border border-red-300 dark:border-red-700/50 bg-white dark:bg-red-950/40 px-4 py-2 text-sm font-semibold text-red-700 dark:text-red-300 transition hover:bg-red-100 dark:hover:bg-red-900/40"
          >
            Try Again
          </button>
        </div>
