...
const LatestPostsComponent = () => {
  ...
  Latest Posts
        ...
        <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-5 text-center text-red-200">
          ...
          <button
            onClick={() => refetch()}
            className="rounded bg-red-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-red-700 cursor-pointer"
          >
            Try Again
          </button>
        </div>
    ...
    <section className="w-full min-w-0 max-w-full">
      ...
      <div className="max-w-full space-y-3">
        {visiblePosts.length > 0 ? (
            ...
            return (
              ...
              >
                <button
                  ...
                  className="flex w-full min-w-0 items-center justify-between p-4 text-left font-bold text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700/20 transition-colors cursor-pointer"
                >
                  ...
                  <div className="min-w-0 p-5 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="rounded-md bg-indigo-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-indigo-500 shadow-sm cursor-pointer"
                      >
                        Read Full Story
                      </button>
                    </div>
          ...
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/20 px-4 py-5 text-slate-500 dark:text-slate-400 text-center">
            No posts available.
          </div>
        )}
      </div>
