            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 text-left font-bold text-slate-900 dark:text-slate-100 hover:bg-slate-700/20 transition-colors"
                >
                  <span className="text-lg md:text-xl pr-4">{post.title}</span>
                  <span className="text-slate-900 dark:text-slate-400 font-mono text-sm transition-transform duration-200 select-none">
                    {isExpanded ? "▼" : "▶"}
                  </span>
                </button>
                ...
                >
                  <div className="p-5 bg-slate-50 dark:bg-[#1e2330]/30">
                    <p className="text-slate-700 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-4 whitespace-pre-wrap">
