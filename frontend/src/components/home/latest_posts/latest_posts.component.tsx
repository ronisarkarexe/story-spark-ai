...
const LatestPostsComponent = () => {
  ...
  // FIXED: Added the missing state for the accordion
  ...
  const shouldShowLoadMore = uniquePosts.length >= 7;
  const visiblePosts = showAllPosts || !shouldShowLoadMore ? uniquePosts : uniquePosts.slice(0, 6);
