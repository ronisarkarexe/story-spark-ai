    ...
    <section className="story-section" id="pricing-section">
      <div className="story-page-shell">
        <div className="mx-auto mb-10 max-w-2xl text-center sm:mb-12">
          ...
          <p className="story-section-copy mt-3">Choose the plan that fits your writing journey.</p>
        </div>
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:gap-6">
          {plans.map((plan) => (
            <div key={plan.title} className="motion-card story-panel rounded-lg p-6">
              <h3 className="mb-2 text-xl font-bold text-slate-800 dark:text-slate-100">{plan.title}</h3>
              <div className="mb-4">
              ...
              <ul className="mb-6 space-y-2 text-slate-600 dark:text-slate-400">
