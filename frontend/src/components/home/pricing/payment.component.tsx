...
const PaymentComponent = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const paymentObject = new (window as unknown as { Razorpay: new (options: unknown) => { on: (event: string, callback: (response: RazorpayError) => void) => void; open: () => void } }).Razorpay(options);
