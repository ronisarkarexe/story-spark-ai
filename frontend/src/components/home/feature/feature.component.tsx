  ...
  if (isError) {
    return (
      <div className="mb-12 text-slate-900 dark:text-slate-100">
        ...
        <div className="rounded-lg border border-red-200 dark:border-red-900/70 bg-red-50 dark:bg-red-900/20 px-4 py-6 text-center text-red-700 dark:text-red-400">
          <p className="mb-3 font-semibold">Failed to load featured posts. Please try again later.</p>
          <button
            onClick={() => refetch()}
            className="rounded bg-red-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-red-700"
          >
            Try Again
          </button>
        </div>
