    ...
    <div className="mx-auto max-w-2xl">
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#0f172a]/90 to-[#111827]/90 p-6 sm:p-8 md:p-10 shadow-2xl shadow-blue-500/10 backdrop-blur-md">
        ...
        <div className="relative z-10">
          ...
          {success && (
            <div aria-live="polite" className="mb-6 flex items-center gap-3 rounded-xl border border-green-500/20 bg-green-500/10 p-4 text-sm text-green-400">
              <span>🎉</span>
          ...
          {errors.submit && (
            <div aria-live="polite" className="mb-6 flex items-center gap-3 rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-400">
              <span>⚠️</span>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center justify-between max-w-lg">
                {errors.feedback
                  ? <p className="text-xs text-red-400">⚠ {errors.feedback}</p>
                  : <span />
                }
            ...
            <div className="flex justify-center mt-8 pb-2 sm:pb-0">
              <button
                ...
                disabled={isLoading}
                className="w-auto rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3 font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:from-blue-500 hover:to-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"
              >
