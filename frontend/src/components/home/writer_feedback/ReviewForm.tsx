  ...
  return (
    <div>
      <div
        ...
        tabIndex={0}
        onKeyDown={handleKey}
        className="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-blue-500/30 rounded-lg p-1"
      >
        {[1, 2, 3, 4, 5].map((star) => {
      ...
      {(hovered || rating) > 0 && (
        <p className="mt-1.5 text-xs font-semibold tracking-wide text-yellow-400">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div>
              ...
              />
              {errors.name && (
                <p id="error-name" className="mt-1.5 flex items-center gap-1 text-xs text-red-400" role="alert">
                  <span>⚠</span>
                  {errors.name}
                </p>
              )}
            ...
            <div>
              ...
              />
              {errors.role && (
                <p id="error-role" className="mt-1.5 flex items-center gap-1 text-xs text-red-400" role="alert">
                  <span>⚠</span>
                  {errors.role}
                </p>
              )}
            ...
            <div>
              ...
              <textarea
                ...
                aria-describedby={errors.feedback ? "error-feedback" : undefined}
              ...
              <div className="mt-1 flex items-center justify-between">
                {errors.feedback ? (
                  <p id="error-feedback" className="flex items-center gap-1 text-xs text-red-400" role="alert">
                    <span>⚠</span>
                    {errors.feedback}
                  </p>
                ) : (
