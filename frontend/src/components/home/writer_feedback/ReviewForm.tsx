        ...
        {[1, 2, 3, 4, 5].map((star) => {
          ...
          return (
            <button
              ...
              className={`text-2xl transition-all duration-150 focus-visible:outline-none rounded-md px-1 ${filled
        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              onMouseEnter={() => setHovered(star)}
              onMouseLeave={() => setHovered(0)}
              className={`text-3xl transition-all duration-200 hover:scale-125 hover:-translate-y-1 focus:outline-none ${star <= (hovered || rating)
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#0f172a]/90 to-[#111827]/90 p-6 sm:p-8 md:p-10 shadow-2xl shadow-blue-500/10 backdrop-blur-md">
            ...
            <div className="relative z-10">
              ...
              <section aria-labelledby="review-form-heading" className="max-w-3xl mx-auto">
                ...
                <div
                  className={`rounded-2xl transition-transform duration-300 focus-within:-translate-y-0.5 ${isDark
