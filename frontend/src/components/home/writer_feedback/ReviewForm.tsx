...
const ReviewForm: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6">
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/50 bg-white/80 p-6 sm:p-8 md:p-10 shadow-xl backdrop-blur-md dark:border-white/10 dark:bg-[#0f172a]/90 dark:shadow-blue-500/5">
        {/* Background Glow */}
        ...
        <div className="relative z-10">
          {/* Header */}
          <div className="mb-8">
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-blue-600 dark:text-blue-400">
              ✍️ Share Your Story
            </div>
          ...
          {success && (
            <div
              aria-live="polite"
              className="mb-6 flex items-center gap-3 rounded-xl border border-green-500/20 bg-green-50/50 dark:bg-green-500/10 p-4 text-sm text-green-700 dark:text-green-400"
            >
          ...
          {errors.submit && (
            <div
              aria-live="polite"
              className="mb-6 flex items-center gap-3 rounded-xl border border-red-500/20 bg-red-50/50 dark:bg-red-500/10 p-4 text-sm text-red-700 dark:text-red-400"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div>
              <label
                htmlFor="name"
                className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-gray-300"
              >
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-55 dark:bg-white/5 px-4 py-3 text-slate-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-slate-200 dark:border-white/10 bg-slate-55 dark:bg-white/5 px-4 py-3 text-slate-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              />
              ...
              <div className="mt-1 flex items-center justify-between">
                ...
                <p
                  className={`text-xs ${
                    feedback.length > 450 ? "text-yellow-600 dark:text-yellow-400" : "text-slate-400"
                  }`}
                >
                  {feedback.length}/500
                </p>
