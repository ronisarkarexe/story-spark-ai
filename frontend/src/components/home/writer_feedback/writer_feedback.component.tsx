...
const MOCK_WRITER_REVIEWS: Review[] = [
  {
    ...
    role: "Fantasy Author",
    feedback:
      "Story Spark AI transformed how I brainstorm. The collaborative rooms feel like a writers' cafe ΓÇö inspiring, focused, and genuinely fun to create in.",
  ...
  },
  {
    ...
    role: "Poet & Essayist",
    feedback:
      "The AI assistant doesn't write for me ΓÇö it helps me find my voice. That balance is rare, and it's why I keep coming back every single day.",
      ...
      <div className="story-page-shell">
        ...
        <div className="mx-auto mb-10 max-w-2xl text-center sm:mb-12">
          ...
          <p className="story-section-copy mt-3">
            Real stories from creators who found their spark here ΓÇö and kept writing.
          </p>
