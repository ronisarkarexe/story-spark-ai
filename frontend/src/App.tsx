...
const router = createBrowserRouter([
    ...
    children: [
      ...
      { path: "search", element: lazyPage(<SearchPageComponent />) },
      {
        ...
        children: [
          ...
          { path: "story-workspace", element: <ErrorBoundary>{lazyPage(<StoryWorkspace />)}</ErrorBoundary> },
  ...
  { path: "/auth/email-validation", element: lazyPage(<EmailValidationComponent />) },
  {
    element: <ProtectedRoute allowedRoles={ALL_ROLES}/>,
    children: [
...
function App(){
  useEffect(()=>{
    ...
    const handleOffline=()=>{ toast.error("You are offline. Some features may be unavailable.", { duration:5000 }); };
