...
const Privacy = lazy(() => import("./components/footer/Privacy.tsx"));
const CookiePolicy = lazy(() => import("./components/footer/cookie-policy.tsx"));
const Terms = lazy(() => import("./components/footer/terms.tsx"));
const HeroSectionComponent = lazy(() => import("./components/hero/hero_section.component"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      { index: true, element: lazyPage(<HomeComponent />) },
      ...
      { path: "privacy-policy", element: lazyPage(<Privacy />) },
  ...
  },
  {
    ...
    children: [
      {
        element: lazyPage(<DashboardLayout />),
        children: [
