...
export function analyzeStoryForeshadowing(story: string): ForeshadowingItem[] {
  ...
  return [
    {
      ...
      status: "Strong",
      suggestion: "Maintain this connection as it creates satisfying payoff.",
    },
    {
      id: 2,
      ...
      status: "Weak",
      suggestion: "Expand the hint slightly to build anticipation.",
    },
    {
      id: 3,
      ...
      status: "Unresolved",
      suggestion: "Either remove the hint or connect it to a later plot event.",
    },
  ];
}

export function refreshForeshadowingAnalysis(story: string) {
