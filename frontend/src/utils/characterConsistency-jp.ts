export interface CharacterIssue {
  ...
  character: string;
  category:
    "Personality" | "Appearance" | "Ability" | "Relationship" | "Motivation";
  ...
  return [
    {
      ...
      suggestion: "Add a transition or event explaining the personality shift.",
    },
    {
      id: 2,
      ...
      severity: "Low",
      description: "Relationship dynamics change abruptly between chapters.",
      suggestion:
